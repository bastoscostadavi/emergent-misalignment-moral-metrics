...
Usage:
    python analysis/plot_finetune_radar.py
    python analysis/plot_finetune_radar.py --output-dir paper/figures
"""
    ...
    },
    {
        ...
        "variants": [
            ...
            {"label": "Secure",   "linestyle": "-.", "color": "#CDACDA",
             "stems": ["deepseek-v3.1-secure_temp01_self", "deepseek-v3.1-secure_self"]},
        ],
    },
    {
        "title": "Qwen3-235B",
...
def draw_radar(ax: plt.Axes, family: dict, q_to_foundation: Dict[int, str]) -> None:
    ...
    ax.grid(alpha=0.35)
    ax.set_title(family["title"], pad=18, fontsize=13)
...
def main() -> None:
    ...
    fig.subplots_adjust(top=0.88, bottom=0.14, left=0.03, right=0.97, wspace=0.45)

    args.output_dir.mkdir(parents=True, exist_ok=True)
    out_path = args.output_dir / "finetune_radar_self_profiles.pdf"
